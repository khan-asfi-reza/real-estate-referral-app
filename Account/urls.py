...
from Account.views.accounts import AuthApi, AccountUpdateApi, CheckEmailAvailableApi
from Account.views.password import ChangePasswordApi, ForgetPasswordApi, ValidateResetLink, ResetPasswordApi
