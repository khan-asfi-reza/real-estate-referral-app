...
from server.apps.Core.models import Recruit, Referral
from django.contrib.auth import get_user_model
import logging
from server.apps.Core.tests.utils import create_test_recruiter
from server.apps.Account.tests.test_utils import get_user_data, get_unique_user_data
from server.apps.Core.views.recruit import RecruitUserCRUDApi, RecruitUserCreateListApi
