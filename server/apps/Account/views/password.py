...
from server.apps.Account.models import ForgetPassword
from server.apps.Core.send_email import SendEmail, get_forget_password_message
from server.apps.Account.serializers import PasswordChangeSerializer
            ...
            try:
                ...
                if not has_threshold_passed or can_request_with_threshold:
                    ...
                    SendEmail.send_html_email(
                        ...
                        subject=" Reza Corporation Agent Referral Password Reset",
